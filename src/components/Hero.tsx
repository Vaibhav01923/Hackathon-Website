...
const Hero: React.FC = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-blue-900 to-cyan-900 relative overflow-hidden">
      {/* Background Effects */}
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            <h1 className="text-5xl md:text-7xl font-bold text-white leading-tight">
              Bit<span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">Battles</span>
            </h1>
            <h2 className="text-2xl md:text-4xl font-light text-gray-300">
              Hackathon 2025
            </h2>
            <p className="text-xl md:text-2xl text-gray-400 max-w-3xl mx-auto">
              Where code meets creativity. Join developers from around the world in 48 hours of innovation, collaboration, and breakthrough solutions.
            </p>
          </div>
          ...
          <div className="mt-12 space-y-6">
            {user ? (
              <div className="space-y-4">
                <p className="text-xl text-green-400">Welcome back, {user.name}!</p>
              ...
              <div className="space-y-4">
                <p className="text-lg text-gray-300">Ready to join the battle?</p>
                <div className="flex flex-col items-center space-y-4">
                  <GoogleAuth />
                  <p className="text-sm text-gray-500">Sign in with Google to register</p>
                </div>
              </div>
            )}
          </div>
